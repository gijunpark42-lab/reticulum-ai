...
3. `python graph_build.py --sync`, then `python dart.py done` to clear the queue.
4. Report per company: label, what was added (n quarterly_data, n contracts, new edges).
